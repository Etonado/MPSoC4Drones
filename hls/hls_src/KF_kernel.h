...
#define		CLK_FREQ		100000000	//MHz

typedef		float		KF_data_t;
//typedef		ap_fixed<16,8>	KF_data_t;

void KalmanFilterKernel(float din[N_CTRL_VARS+N_MEAS_VARS], float dout[N_STATE_VARS], float q, float r, ap_uint<32> counter,int set1);
