...
// wrapc file define:
#define AUTOTB_TVIN_set1 "../tv/cdatafile/c.KalmanFilterKernel.autotvin_set1.dat"
#define AUTOTB_TVOUT_set1 "../tv/cdatafile/c.KalmanFilterKernel.autotvout_set1.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_set1 "../tv/rtldatafile/rtl.KalmanFilterKernel.autotvout_set1.dat"
...
extern "C" void KalmanFilterKernel_hw_stub_wrapper(volatile void *, volatile void *, float, float, __cosim_s4__*, int);

extern "C" void apatb_KalmanFilterKernel_hw(volatile void * __xlx_apatb_param_din, volatile void * __xlx_apatb_param_dout, float __xlx_apatb_param_q, float __xlx_apatb_param_r, __cosim_s4__* __xlx_apatb_param_counter, int __xlx_apatb_param_set1) {
...
//set1
aesl_fh.touch(AUTOTB_TVIN_set1);
aesl_fh.touch(AUTOTB_TVOUT_set1);
...
// print set1 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_set1, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_set1);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_set1, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.set1_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_set1, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
KalmanFilterKernel_hw_stub_wrapper(__xlx_apatb_param_din, __xlx_apatb_param_dout, __xlx_apatb_param_q, __xlx_apatb_param_r, __xlx_apatb_param_counter, __xlx_apatb_param_set1);
