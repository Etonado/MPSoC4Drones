...
extern "C" void KalmanFilterKernel(int*, int*, float, float, __cosim_s4__, int);
extern "C" void apatb_KalmanFilterKernel_hw(volatile void * __xlx_apatb_param_din, volatile void * __xlx_apatb_param_dout, float __xlx_apatb_param_q, float __xlx_apatb_param_r, __cosim_s4__ __xlx_apatb_param_counter, int __xlx_apatb_param_set1) {
  ...
  // DUT call
  KalmanFilterKernel(__xlx_din__input_buffer, __xlx_dout__input_buffer, __xlx_apatb_param_q, __xlx_apatb_param_r, __xlx_apatb_param_counter, __xlx_apatb_param_set1);
