...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins KalmanFilterKernel_0/s_axi_AXI_CPU] [get_bd_intf_pins axi_smc/M03_AXI]
  ...
  connect_bd_net -net KalmanFilterKernel_0_din_address0 [get_bd_pins KalmanFilterKernel_0/din_address0] [get_bd_pins bram_addr_mapper_1/addr_in]
  ...
  connect_bd_net -net KalmanFilterKernel_0_dout_address0 [get_bd_pins KalmanFilterKernel_0/dout_address0] [get_bd_pins bram_addr_mapper_0/addr_in]
  connect_bd_net -net KalmanFilterKernel_0_dout_ce0 [get_bd_pins KalmanFilterKernel_0/dout_ce0] [get_bd_pins axi_bram_ctrl_0_bram1/enb]
  connect_bd_net -net KalmanFilterKernel_0_dout_d0 [get_bd_pins KalmanFilterKernel_0/dout_d0] [get_bd_pins axi_bram_ctrl_0_bram1/dinb]
  ...
  connect_bd_net -net bram_addr_mapper_1_addr_out [get_bd_pins axi_bram_ctrl_0_bram1/addrb] [get_bd_pins bram_addr_mapper_1/addr_out]
  connect_bd_net -net bram_addr_mapper_1_rst_out [get_bd_pins axi_bram_ctrl_0_bram1/rstb] [get_bd_pins bram_addr_mapper_1/rst_out]
  connect_bd_net -net bram_addr_mapper_1_wr_out [get_bd_pins axi_bram_ctrl_0_bram1/web] [get_bd_pins bram_addr_mapper_1/wr_out]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins KalmanFilterKernel_0/ap_rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins bram_addr_mapper_0/n_rst_in] [get_bd_pins bram_addr_mapper_1/n_rst_in] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins bram_addr_mapper_0/wr_in] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins KalmanFilterKernel_0/counter] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins KalmanFilterKernel_0/set1] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins KalmanFilterKernel_0/ap_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_bram_ctrl_0_bram1/clkb] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
